...
exec {
  ...
  command = "/usr/bin/openresty -c /etc/nginx/conf.d/apigateway.conf -g 'daemon off;'"
...
template {
  ...
  # the `contents` option.
  source = "/usr/src/apigateway/apigateway.ctmpl"

  # This is the destination path on disk where the source template will render.
  # If the parent directories do not exist, Consul Template will attempt to
  # create them.
  destination = "/etc/nginx/conf.d/apigateway.conf"
